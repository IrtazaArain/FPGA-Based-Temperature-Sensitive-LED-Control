...
HD_PWD='D:/7th Semester/Digital System Design CS-431/Labs/CEP/FPGA-Based_Temperature_Sensitive_LED_Control/FPGA-Based_Temperature_Sensitive_LED_Control.runs/synth_1'
cd "$HD_PWD"
